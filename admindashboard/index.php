...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $email = $_POST['email'];
  $student->addStudent($email, $_POST['password'], $_POST['groupId'], $_POST['nom'], $_POST['prenom'], $_POST['year'], $_POST['filiereId']);
}
...
<input type="email" class="form-control" id="email" name="email" required pattern="[a-zA-Z0-9._%+-]+@edu-emsi\.ma">
</div>
